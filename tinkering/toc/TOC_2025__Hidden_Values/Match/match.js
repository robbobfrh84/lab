...
const buildMatch = function() {
  ...
  matchTop.innerHTML = /*html*/`
    <div class="match-row">
      ...
      <div class="match-separator">:</div>
      <div class="match-value region pill-box" style="${topRegionStyle}">${topChar.region}</div>
  ...
  matchBot.innerHTML = /*html*/`
    <div class="match-row">
      ...
      <div class="match-separator">:</div>
      <div class="match-value region pill-box" style="${botRegionStyle}">${botChar.region}</div>
    </div>
  `
}
