export const Circle2 = {
  ...
  borderStroke: 30, // * Total thickness of border
  holeR: 40, // * Hole Radius
  betweenHoles: 80, // * Space between button holes from center
  OS: [15,15,3], // * Outer shadow: x, y, blur. 🚨 NOTE: Don't use magin for 0,1 index. because it will be changed if the angle changes! 
  IS: [15,15,3], // * Inner Shadow: "" Math is slightly different here. so some tinkering needed.
  get OHS() { return [10, 10, this.holeR] }, // * Outer Hold Shadow [OffsetX,offSety,Radius].
